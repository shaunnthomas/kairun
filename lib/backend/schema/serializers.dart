...
import 'question_db_record.dart';
import 'saved_question_record.dart';
import 'varc_activities_record.dart';
import 'user_section_recommendations_record.dart';
import 'daily_workouts_list_record.dart';
import 'section_results_record.dart';
import 'topic_recommendations_record.dart';
import 'dilr_activities_record.dart';
...
@SerializersFor(const [
  ...
  QuestionDbRecord,
  SavedQuestionRecord,
  VarcActivitiesRecord,
  UserSectionRecommendationsRecord,
  DailyWorkoutsListRecord,
  SectionResultsRecord,
  TopicRecommendationsRecord,
  DilrActivitiesRecord,
